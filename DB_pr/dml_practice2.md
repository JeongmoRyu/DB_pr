...
INSERT INTO hotels (room_num, check_in, check_out, grade, price)
VALUES
...
SELECT rowid AS 'id', room_num, check_in, check_out, grade, price FROM hotels;

UPDATE hotels
SET check_in='2022-01-04'
WHERE room_num='807';

SELECT rowid AS 'id', * FROM hotels WHERE room_num LIKE 'B%' OR grade='deluxe';
```